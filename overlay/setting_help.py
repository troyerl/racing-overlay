...
HELP_OVERRIDES: dict[str, str] = {
    ...
    "show_irating_projection": "Shows projected iRating +/- during races.",
    ...
    "delta_bar.mode": "Which lap the delta bar compares against.",
    ...
    "dash.show_delta_bar": "When on, shows the thin live delta bar across the top of the dash.",
    ...
    # --- leaderboard strip ---
    "leaderboard_strip.rows": "How many drivers to show in the compact strip.",
    "leaderboard_strip.show_position": "When on, shows race position (P1, P2, …).",
    "leaderboard_strip.show_name": "When on, shows driver names.",
    "leaderboard_strip.show_car_number": "When on, shows car numbers.",
    "leaderboard_strip.show_gap": "When on, shows gap to the car ahead.",
    "leaderboard_strip.show_class_color": "When on, shows class-color stripes.",
